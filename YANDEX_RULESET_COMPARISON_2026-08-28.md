...
бы один из семи ожидаемых group ID. Симптомы, причина, воспроизведение и
защитные меры подробно разобраны в
[журнале проблем настройки](SWS_SETUP_ISSUES_2026-08-28.md).
